...
export const DetailProductPrice = () => {
  return (
    ...
    <button onClick={()=>dispatch(add(item))} className="btn btn-outline-success px-5 py-2 mt-5 fw-semibold fs-5">
      ADD
    </button>
    <h4 className="mt-5">Why shop from blinkit?</h4>
    <div className="row mt-5">
      <div className="col-2">
        <img src="https://d2gg9evh47fn9z.cloudfront.net/800px_COLOURBOX32430946.jpg" alt="df" height={90} width={-15} />
      </div>
    ...
    <div className="row mt-3">
      <div className="col-2">
      <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQNkCIkGeta03RPYAbs5kL7Ubwo0zkRROT6DtVM6JRBIoNfzYIWxu1vFC-QcUi_SYvuvDk&usqp=CAU" alt="df" height={90} width={-15} />
      </div>
      <div className="col-10">
      <p>
    ...
    <div className="row mt-3">
      <div className="col-2">
      <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/73/Flat_tick_icon.svg/1024px-Flat_tick_icon.svg.png" alt="df" height={80} width={-15}
      />
      </div>
     <div className="col-10">
     <p>
